...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">理发店网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>UserOrder/frontlist">用户预约</a></li>
                <li><a href="<%=basePath %>Xiaofei/frontlist">消费记录</a></li> -->
                <li><a href="<%=basePath %>Barber/frontlist">理发师风采</a></li>
                <li><a href="<%=basePath %>ServiceItem/frontlist">服务项目介绍</a></li>
                
                <li><a href="<%=basePath %>Paiban/frontlist">理发师排班</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>UserOrder/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的预约查询</a></li>
                        <li><a href="<%=basePath %>Xiaofei/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的消费记录</a></li>
