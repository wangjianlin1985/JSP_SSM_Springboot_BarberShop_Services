...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>消费项目</td><td>消费金额</td><td>消费时间</td><td>服务理发师</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="xiaofeiQueryForm" id="xiaofeiQueryForm" action="<%=basePath %>Xiaofei/userFrontlist" class="mar_t15" method="post">
            ...
            <div class="form-group">
            	<label for="barberObj_barberId">服务理发师：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="xiaofei_barberObj_barberId_edit" class="col-md-3 text-right">服务理发师:</label>
		  	 <div class="col-md-9">
