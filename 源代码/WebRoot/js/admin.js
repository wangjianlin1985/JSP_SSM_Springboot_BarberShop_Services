		       ...
		       text: "理发师管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Barber/barber_add.jsp"
			    	   	},
			    		{
			    	   		text: "理发师管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Barber/barber_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "服务项目管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "ServiceItem/serviceItem_add.jsp"
			    	   	},
			    		{
			    	   		text: "服务项目管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ServiceItem/serviceItem_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "用户预约管理",
		       ...
		       text: "理发师排班管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Paiban/paiban_add.jsp"
			    	   	},
			    		{
			    	   		text: "理发师排班管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Paiban/paiban_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "新闻公告管理",
