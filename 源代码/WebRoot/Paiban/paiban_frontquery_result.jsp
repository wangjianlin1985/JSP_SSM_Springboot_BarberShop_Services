		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#paibanListPanel" aria-controls="paibanListPanel" role="tab" data-toggle="tab">理发师排班列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Paiban/paiban_frontAdd.jsp" style="display:none;">添加理发师排班</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>排班id</td><td>理发师</td><td>排班时间</td><td>工作时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<paibanList.size();i++) {
					    	            		...
					    	            		Paiban paiban = paibanList.get(i); //获取到理发师排班对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="paibanQueryForm" id="paibanQueryForm" action="<%=basePath %>Paiban/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="barberObj_barberId">理发师：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;理发师排班信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="paiban_barberObj_barberId_edit" class="col-md-3 text-right">理发师:</label>
		  	 <div class="col-md-9">
