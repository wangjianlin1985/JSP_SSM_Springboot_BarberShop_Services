...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>ServiceItem/frontlist">服务项目信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>ServiceItem/serviceItem_frontAdd.jsp" style="display:none;">添加服务项目</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<serviceItemList.size();i++) {
            		...
            		ServiceItem serviceItem = serviceItemList.get(i); //获取到服务项目对象
            		String clearLeft = "";
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;服务项目信息编辑</h4>
      </div>
